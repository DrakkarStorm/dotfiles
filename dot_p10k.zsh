# Generated by Powerlevel10k configuration wizard on 2025-02-22 at 14:01 EST.
...
# 12h time, slanted separators, sharp heads, flat tails, 2 lines, dotted, full frame,
...
() {
  ...
  function prompt_env() {
    local username=${USERNAME%default}
    p10k segment -f 'blue' -t "${username}"
  }
